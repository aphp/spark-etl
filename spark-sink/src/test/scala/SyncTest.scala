...
class SyncTest extends SolrConfTest {       //QueryTest with SparkSessionTestWrapper with SolrCloudTestBuilder{

  //@Test
  def verifySyncDeltaToPostgres(): Unit = {

    println("Sync Delta To Postgres")
    ...
    /*val pgConfTest:PostgresConfTest = new PostgresConfTest
  ...
  def verifySyncDeltaToSolr(): Unit = {
    ...
    println("Sync Delta to Solr")
    val deltaConfTest:DeltaConfTest = new DeltaConfTest
    deltaConfTest.createDeltaTables

    //startSolrCloudCluster
    createSolrTables
    /*val solrConfTest:SolrConfTest = new SolrConfTest
    ...
    /*val solrc = new SolrConf(config, dates, pks)
  ...
  def verifySyncPostgresToSolr(): Unit = {
    ...
    println("Sync Postgres To Solr")
    /*val postgresConfTest:PostgresConfTest = new PostgresConfTest
  ...
  def verifySyncPgToPg(): Unit = {
    ...
    println("Sync Postgres to Postgres")

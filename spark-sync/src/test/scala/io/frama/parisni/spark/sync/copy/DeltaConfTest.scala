...
class DeltaConfTest extends QueryTest with SparkSessionTestWrapper {
  ...
  def createDeltaTables(): Unit = { // Uses JUnit-style assertions
    ...
    println(
      "Before: Table /tmp/source exists = " + checkTableExists(
        spark,
        "/tmp",
        "source"
      )
    ...
    val sInputDF: DataFrame = ((
      ...
      Timestamp.valueOf("2016-01-16 00:00:00"),
      Timestamp.valueOf("2016-02-16 00:00:00")
    ) ::
      (
        2,
        "id2s",
        ...
        Timestamp.valueOf("2016-03-16 00:00:00"),
        Timestamp.valueOf("2016-04-16 00:00:00")
      ) ::
      (
        3,
        "id3s",
        ...
        Timestamp.valueOf("2016-05-16 00:00:00"),
      ...
      (
        ...
        Timestamp.valueOf("2016-07-16 00:00:00"),
        Timestamp.valueOf("2016-08-16 00:00:00")
      ) ::
      (
        5,
        "id5",
        ...
        Timestamp.valueOf("2016-09-16 00:00:00"),
        Timestamp.valueOf("2016-10-16 00:00:00")
      ) ::
      (
        6,
        "id6",
        ...
        Timestamp.valueOf("2016-11-16 00:00:00"),
        Timestamp.valueOf("2016-12-16 00:00:00")
      ) ::
      Nil).toDF(
      "id",
      "pk2",
    ...
    println(
      "After: table /tmp/source exists = " + checkTableExists(
        spark,
        "/tmp",
        "source"
      )
    ...
    println(
      "table /tmp/target exists = " + checkTableExists(spark, "/tmp", "target")
    )
  ...
  def verifySyncDeltaToDelta(): Unit = {
    ...
    val mapy = Map(
      ...
      "T_TABLE_NAME" -> "target",
      "T_TABLE_TYPE" -> "delta",
      "T_DATE_MAX" -> "2019-12-26 23:16:16",
      "PATH" -> "/tmp",
      "T_LOAD_TYPE" -> "scd1"
    )
  ...
  def verifCalculDateMax(): Unit = {
    ...
    val mapy = Map(
      ...
      "S_DATE_FIELD" -> "date_update",
      "T_TABLE_NAME" -> "target",
      "T_TABLE_TYPE" -> "delta", //"T_DATE_MAX" -> "2016-10-16 23:16:16",
      "PATH" -> "/tmp",
      "T_LOAD_TYPE" -> "full"
    )
    val dates = List("date_update", "date_update2", "date_update3")
    ...
    assert(
      dateMax == "2019-09-25 20:16:07.0"
    ) //"2016-10-16 23:16:16"))    "2019-06-26 23:10:02.0"
  }

  ...
  def createTables(): Unit = {
    ...
    val metaTableDF: DataFrame = (
      (1, "spark-prod", "t1", Timestamp.valueOf("2020-03-16 00:00:00"), -1, "delta", comp1Path) ::
        (2, "spark-prod", "t2", Timestamp.valueOf("2020-03-17 00:00:00"), -1, "postgres", comp2Path) ::
        (3, "db-test", "t3", Timestamp.valueOf("2020-03-18 00:00:00"), -1, "delta", comp3Path) ::
        (4, "spark-prod", "t4", Timestamp.valueOf("2020-03-19 00:00:00"), -1, "delta", comp4Path) ::
    ...
    val comp1DF: DataFrame = (
      (1, "text l1", "date l1") :: (2, "text l2", "date l2") :: (3, "text l3", "date l3") :: (4, "text l4", "date l4") ::
        (5, "text l5", "date l5") :: (6, "text l6", "date l6") :: (7, "text l7", "date l7") :: (8, "text l8", "date l8") ::
        (9, "text 19", "date l9") :: (10, "text l10", "date l10") :: (11, "text l11", "date l11") :: (12, "text l12", "date l12") ::
        (13, "text l13", "date l13") :: (14, "text l14", "date l14") :: (15, "text l15", "date l15") :: (16, "text l16", "date l16") ::
        (17, "text l17", "date l17") :: (18, "text l18", "date l18") :: (19, "text l19", "date l19") :: (20, "text l20", "date l20") ::
        (21, "text l21", "date l21") :: (22, "text l22", "date l22") :: (23, "text l23", "date l23") :: (24, "text l24", "date l24") ::
        (25, "text l25", "date l25") :: (26, "text l26", "date l26") :: (27, "text 127", "date l27") :: (28, "text l28", "date l28") ::
        (29, "text l29", "date l29") :: (30, "text l30", "date l30") :: (31, "text l31", "date l31") :: (32, "text l32", "date l32") ::
        (33, "text l33", "date l33") :: (34, "text l34", "date l34") :: (35, "text l35", "date l35") :: (36, "text l36", "date l36") ::
        (37, "text l37", "date l37") :: (38, "text l38", "date l38") :: (39, "text l39", "date l39") :: (40, "text l40", "date l40") ::
